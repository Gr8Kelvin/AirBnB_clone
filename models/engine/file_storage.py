...
class FileStorage:
    ...
    def reload(self):
        ...
        if not os.path.isfile(FileStorage.__file_path):
            return
        with open(FileStorage.__file_path, "r", encoding="utf-8") as fsa:
            obj_dict = json.load(fsa)
            obj_dict = {ksa: self.classes()[vsa["__class__"]](**vsa)
                        for ksa, vsa in obj_dict.items()}
